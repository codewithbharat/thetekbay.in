  ...
  return (
    <section className=" border-b-black border-b-2 mb-4 border-t-4 flex justify-center gap-4">
      ...
      {toggle && (
        <nav
          ref={navRef}
          className="absolute right-0 h-screen md:h-auto justify-start md:justify-center w-2/3 md:w-auto px-5 text-right  flex-col md:flex-row  md:static flex gap-4 p-4 font-medium"
        >
